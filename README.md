python -m torch.distributed.launch --nproc_per_node=2  --use_env opencood/tools/train.py --hypes_yaml opencood/hypes_yaml/opv2v/mm/mm.yaml


# CoAlign (ICRA2023)
python opencood/tools/train.py --hypes_yaml /home/jiaqi2/Zonglin/MM_opv2v/opencood/hypes_yaml/opv2v/mm/mm_add.yaml
