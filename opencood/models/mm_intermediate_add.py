...
class MMIntermediateAdd(LiftSplatShoot):
    def __init__(self, args): 
        super(MMIntermediateAdd, self).__init__(args)
    ...
    def forward(self, data_dict):
        ...
        try:
            ...
            #print('lidar', data_dict['processed_lidar'])
            #print('record_len',data_dict['record_len'])
        except:
            print('lidar', data_dict['processed_lidar']['voxel_features'].shape)
            print('cor',data_dict['processed_lidar']['voxel_coords'])
            print('record_len',data_dict['record_len'])
        multi_agent_dict = {
