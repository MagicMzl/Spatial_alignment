    ...
    class IntermediateFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base):
            ...
            if self.load_camera_file:
                ...
                for idx, img in enumerate(camera_data_list):
                    ...
                    euler_angles_xyz[2] = euler_angles_xyz[2] + noise
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                #np.save("./" + str(_i), selected_cav_processed['lidar_np'])
                #print('lidar2img', selected_cav_processed['image_inputs']['lidar2img'])
                #print('extrinsics', selected_cav_processed['image_inputs']['extrinsics'])
                #print('intrins', selected_cav_processed['image_inputs']['intrins'])
        ...
        def collate_batch_train(self, batch):
            ...
            for i in range(len(batch)):
                ...
                for i in ego_dict['lidar_np']:
                    #print(np.array(i).shape)
                    lidar_np_list.append(np.array(i))
            ...
            #print('lidar_np_list',lidar_np_list)
