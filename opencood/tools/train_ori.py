...
def main():
    ...
    #cam_saved_path = '/home/jiaqi2/Zonglin/MM_opv2v_two/opencood/logs/camera_pretrained/net_epoch_bestval_at36.pth'
    #model.load_state_dict(torch.load(
    #        cam_saved_path, map_location='cpu'), strict=False)
    
    #range_view_saved_path = '/home/jiaqi2/Zonglin/MM_opv2v_two/opencood/logs/range_view_image_lidar/net_epoch_bestval_at15.pth'
    #model.load_state_dict(torch.load(
    #        cam_saved_path, map_location='cpu'), strict=False)
        #lowest_val_epoch = init_epoch
        #scheduler = train_utils.setup_lr_schedular(hypes, optimizer, init_epoch=init_epoch)
    ...
    camencode_weights = torch.load('/home/cav/projects/Zonglin/MM_opv2v_two/opencood/logs/camera_pretrained/net_epoch_bestval_at36.pth')
    print(model.camencode)
    model.camencode.load_state_dict(camencode_weights)
    print('#################### LOAD range view NETWORK ####################')
    # Load pretrained weights for camencode_range_view
    camencode_range_view_weights = torch.load('/home/cav/projects/Zonglin/MM_opv2v_two/opencood/logs/range_view_image_lidar/net_epoch_bestval_at15.pth')
    model.camencode_range_view.load_state_dict(camencode_range_view_weights)
